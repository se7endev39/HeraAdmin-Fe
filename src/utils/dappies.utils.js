...
import { COMMON, Dibbs_RARITY_DISTRIBUTION, DEFAULT_DAPPIES, RARE, ULTRARARE } from "../config/dappies.config";
...
export const createRandomDappies = (number = 1, options) => {
  ...
  for (let i = 0; i < number; i++) {
    console.log(i)
    let rarity = customRarity || Dibbs_RARITY_DISTRIBUTION[createRandomNumber(Dibbs_RARITY_DISTRIBUTION.length)]
    let newborn = {
